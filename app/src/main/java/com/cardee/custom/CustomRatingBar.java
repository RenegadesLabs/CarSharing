...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.ic_star_rate;
    private int mStarOffResource = R.drawable.ic_star_rate_inactive;
    private int mStarHalfResource = R.drawable.ic_star_rate;
    ...
    private float getScoreForPosition(float x) {
        ...
        float temp = ((float) getWidth() / (mMaxStars)) + 1;
        float value = (int) ((x / temp) + 1);
        if (value > mMaxStars) {
            value = mMaxStars;
        }
