...
public class DayHolderDelegate {
    ...
    public DayHolderDelegate(BodyConfig config) {
        this.config = config;
    ...
    public DayHolder onCreateViewHolder(ViewGroup parent) {
    ...
    private View createMonthView(Context context) {
        ...
        recyclerView.setAdapter(new HourAdapter(config));
        return recyclerView;
    }
