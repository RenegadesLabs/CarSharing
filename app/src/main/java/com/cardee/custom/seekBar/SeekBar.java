...
public class SeekBar extends View {
    ...
    public Bitmap drawableToBitmap(Drawable drawable) {
        ...
        pxWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 60, r.getDisplayMetrics());
        pxHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 33, r.getDisplayMetrics());
        Bitmap resized = Bitmap.createScaledBitmap(bitmap, pxWidth, pxHeight, false);
        return resized;
    }
...
//        return this;
    ...
    public SeekBar setBarHeight(float barHeight) {
        this._barHeight = barHeight;
        return this;
    }

    public SeekBar setBarColorMode(int barColorMode) {
    ...
    public SeekBar setBarGradientStart(int barGradientStart) {
        this.barGradientStart = barGradientStart;
        return this;
    }

    public SeekBar setBarGradientEnd(int barGradientEnd) {
        this.barGradientEnd = barGradientEnd;
        return this;
    }

    public SeekBar setBarHighlightColorMode(int barHighlightColorMode) {
    ...
    public SeekBar setBarHighlightGradientStart(int barHighlightGradientStart) {
        this.barHighlightGradientStart = barHighlightGradientStart;
        return this;
    }

    public SeekBar setBarHighlightGradientEnd(int barHighlightGradientEnd) {
        this.barHighlightGradientEnd = barHighlightGradientEnd;
        return this;
    }

    public SeekBar setThumbColor(int leftThumbColorNormal) {
        this.thumbColorNormal = leftThumbColorNormal;
        return this;
    }

    public SeekBar setThumbHighlightColor(int leftThumbColorPressed) {
        this.thumbColorPressed = leftThumbColorPressed;
        return this;
    }

    public SeekBar setThumbDrawable(int resId) {
        setThumbDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public SeekBar setThumbDrawable(Drawable drawable) {
        setThumbBitmap(getBitmap(drawable));
        return this;
    }

    public SeekBar setThumbBitmap(Bitmap bitmap) {
        thumb = bitmap;
        return this;
    }

    public SeekBar setThumbHighlightDrawable(int resId) {
        setThumbHighlightDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public SeekBar setThumbHighlightDrawable(Drawable drawable) {
        setThumbHighlightBitmap(getBitmap(drawable));
        return this;
    }

    public SeekBar setThumbHighlightBitmap(Bitmap bitmap) {
        thumbPressed = bitmap;
        return this;
    }
