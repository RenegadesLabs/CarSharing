...
//        return (drawable != null) ? ((BitmapDrawable) drawable).getBitmap() : null;
    ...
    protected int getBarColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.RangeSeekBar_bar_color_mode, RangeSeekBar.ColorMode.SOLID);
    }
    ...
    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.RangeSeekBar_bar_highlight_color_mode, RangeSeekBar.ColorMode.SOLID);
    }
...
//        return typedArray.getDimensionPixelSize(R.styleable.RangeSeekBar_thumb_diameter, getResources().getDimensionPixelSize(R.dimen.thumb_width));
        return pxWidth;
    }
    ...
    protected void setupBar(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        if (barColorMode == RangeSeekBar.ColorMode.SOLID) {
    ...
    protected void setupHighlightBar(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        if (barHighlightColorMode == RangeSeekBar.ColorMode.SOLID) {
...
//        rectRightThumb.right = Math.min(rectRightThumb.left + (getThumbWidth() / 2) + barPadding, getWidth());
        rectRightThumb.right = rectRightThumb.left + (getThumbWidth() / 2) + barPadding;
