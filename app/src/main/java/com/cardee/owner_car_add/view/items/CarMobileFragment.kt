...
class CarMobileFragment : Fragment(), NewCarFormsContract.View {

    companion object {
        fun newInstance(): CarMobileFragment {
            return CarMobileFragment()
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val v = inflater?.inflate(R.layout.fragment_add_car_mobile, container, false)
        return v
    }
