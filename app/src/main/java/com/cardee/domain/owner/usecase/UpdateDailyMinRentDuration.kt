...
class UpdateDailyMinRentDuration : UseCase<UpdateDailyMinRentDuration.RequestValues, UpdateDailyMinRentDuration.ResponseValues> {
    ...
    override fun execute(values: RequestValues, callback: UseCase.Callback<ResponseValues>) {
        repository.updateMinRentDaily(values.carId, MinRentalDurationEntity(values.duration),
