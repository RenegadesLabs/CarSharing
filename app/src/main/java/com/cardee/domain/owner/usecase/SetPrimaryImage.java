...
public class SetPrimaryImage
        implements UseCase<SetPrimaryImage.RequestValues, SetPrimaryImage.ResponseValues> {
    ...
    @Override
    public void execute(RequestValues values, final UseCase.Callback<ResponseValues> callback) {
        ...
        repository.setPrimaryImage(id, imageId, new CarEditDataSource.Callback() {
            @Override
