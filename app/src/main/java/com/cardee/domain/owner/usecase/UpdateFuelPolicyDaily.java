...
public class UpdateFuelPolicyDaily implements UseCase<UpdateFuelPolicyDaily.RequestValues, UpdateFuelPolicyDaily.ResponseValues>{

    private final CarEditRepository mRepository;

    public UpdateFuelPolicyDaily() {
