...
data class OfferDetails(@Expose @SerializedName("car_details") val carDetails: OfferCarDetails?,
...
data class OfferOrderDetails(@Expose @SerializedName("is_instant_booking") val isInstantBooking: Boolean?,
                             ...
                             @Expose @SerializedName("fuel_policy") val fuelPolicy: List<FuelPolicyEntity>?,
