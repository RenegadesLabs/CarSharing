...
data class OfferByIdResponseBody(@Expose @SerializedName("car_details") val carDetails: OfferByIdCarDetails?,
                                 ...
                                 @Expose @SerializedName("car_availability_daily") val carAvailabilityDaily: List<String>?,
                                 ...
                                 @Expose @SerializedName("car_availability_hourly") val carAvailabilityHourly: List<String>?,
